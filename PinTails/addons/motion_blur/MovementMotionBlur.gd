...
func _process(_delta):
	...
	if camera is Camera3D:
		...
		var velocity = camera.global_transform.origin - cam_pos_prev
		...
		var cam_rot = Quaternion(camera.global_transform.basis)
		...
		cam_pos_prev = camera.global_transform.origin
